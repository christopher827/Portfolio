...
initial={{x:0,y:0}}
whileInView={{x:x,y:y,transitionDuration:{duration:1.5}}}
viewport={{once:true}}
>
{name}
</motion.div>
...
<div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circulaDarkLg 
md:bg-circularLightMd md:dark:bg-circulaDarkMd
sm:bg-circularLightSm sm:dark:bg-circulaDarkSm
'>
...
{/* <Skill name=".NetFrameworks" x="-25vw" y="2vw"/> */}
<Skill name="Cypress" x="-25vw" y="2vw"/>
<Skill name="Tailwind CSS" x="-5vw" y="-10vw"/>
<Skill name="MongoDB" x="20vw" y="6vw"/>
<Skill name="Azure" x="0vw" y="12vw"/>
