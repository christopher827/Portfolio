...
<div className='w-1/2 md:w-full'>
  <img src={DevPic} alt='Christopher Oche' className='w-full h-auto lg:hidden md:inline-block md:w-full' sizes="{max-width:768px } 100vw, {max-width:1200px} 50vw, 50vw"/>
</div>
...
<p className='my-4 text-base font-medium md:text-sm sm:text-xs '>As a skilled software engineer, I turn ideas into innovative web and AI solutions. Explore my latest projects and articles showcasing expertise in Software Engineering and Artificial Intelligence.</p>
